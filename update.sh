...
curl -z CH32V103DS0.PDF -o CH32V103DS0.PDF https://www.wch.cn/downloads/file/311.html
# https://www.wch.cn/downloads/CH32xRM_PDF.html
curl -z CH32xRM.PDF -o CH32xRM.PDF https://www.wch.cn/downloads/file/328.html
cd ..

# https://www.wch.cn/downloads/CH32V103EVT_ZIP.html
curl -z CH32V103EVT.ZIP -o CH32V103EVT.ZIP https://www.wch.cn/downloads/file/326.html
rm -rfv EVT
unzip -O GB2312 *.ZIP
