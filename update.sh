...
fetch "https://www.wch-ic.com/download/file?id=312" CH32V103DS0.PDF
# https://www.wch-ic.com/downloads/CH32xRM_PDF.html
fetch "https://www.wch-ic.com/download/file?id=306" CH32xRM.PDF
cd ..

cd datasheet_zh
# https://www.wch.cn/downloads/CH32V103DS0_PDF.html
fetch "https://file.wch.cn/download/file?id=311" CH32V103DS0.PDF
# https://www.wch.cn/downloads/CH32xRM_PDF.html
fetch "https://file.wch.cn/download/file?id=328" CH32xRM.PDF
cd ..

# https://www.wch.cn/downloads/CH32V103EVT_ZIP.html
fetch "https://file.wch.cn/download/file?id=326" CH32V103EVT.ZIP
if [ "$LAST_FETCH_OK" = 1 ]; then unzip_evt CH32V103EVT.ZIP; fi
